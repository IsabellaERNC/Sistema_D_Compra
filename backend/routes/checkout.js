...
module.exports = (pool, verificarToken, io) => {
    ...
    router.post('/iniciar', verificarToken, async (req, res) => {
        ...
        try {
            /* ── 1. Validar que la dirección pertenezca al usuario ── */
            ...
            const envio = subtotal < 200000 ? 15000 : 0;
            ...
            /* ── 5. Guardar transacción (PENDIENTE) ── */
            ...
            /* ── 6. Preparar datos para pasarela ── */
            ...
            /* ── 8. Actualizar referencia externa ── */
            await pool.query(
